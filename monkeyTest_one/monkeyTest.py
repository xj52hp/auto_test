...
def destroy(devices):
    shutil.rmtree((PATH(info_dir)))
    OperateFile(PATH(info_dir + devices + "_cpu.pickle")).remove_file()
    OperateFile(PATH(info_dir + devices + "_men.pickle")).remove_file()
    OperateFile(PATH(info_dir + devices + "_flow.pickle")).remove_file()
    OperateFile(PATH(info_dir + devices + "_battery.pickle")).remove_file()
    OperateFile(PATH(info_dir + devices + "_fps.pickle")).remove_file()
    OperateFile(PATH(info_dir + "info.pickle")).remove_file()
    OperateFile(PATH(info_dir + "sumInfo.pickle")).remove_file()
